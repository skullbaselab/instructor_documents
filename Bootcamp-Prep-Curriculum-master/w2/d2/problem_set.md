...
// if the email is considered valid.
//
// A valid email:
...
//
// Feel free to use the following arrays in your solution:
// var alphabet = [
//   "a","b","c","d","e",
//   "f","g","h","i","j",
//   "k","l","m","n","o",
...
//
// Hint: If a `string` contains a single `@` inside it, then we are guaranteed to get an
// array of length 2, when we do `string.split('@')`.
```
